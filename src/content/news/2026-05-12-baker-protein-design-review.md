---
title: "综述 | David Baker课题组全面解读蛋白质计算设计的过去、现在与未来"
date: 2026-05-12
...
> **📝 转载说明**
> 本文转载自微信公众号：**WangLab 王初课题组** （发表于 2026年5月3日）。
> 导读作者：杨为研究员（深圳医学科学院，该综述第一作者）。
> 原文文献：*The Past, Present and Future of De Novo Protein Design*, Nature, 2026. (https://doi.org/10.1038/s41586-026-10328-7)
...
<div class="flex flex-col items-center my-12">
  <img src="/images/20260512/fig1.webp" class="w-full md:w-2/3 rounded-xl shadow-lg border border-white/10" alt="图1" />
  <p class="text-sm text-slate-500 mt-4 italic">图1：用于设计具有全新目标功能蛋白质的计算设计工作流程与代表性成果</p>
</div>
...
<div class="flex flex-col items-center my-12">
  <img src="/images/20260512/fig2.webp" class="w-full md:w-2/3 rounded-xl shadow-lg border border-white/10" alt="图2" />
  <p class="text-sm text-slate-500 mt-4 italic">图2：从头设计蛋白结合蛋白及其治疗应用示例</p>
</div>
...
<div class="flex flex-col items-center my-12">
  <img src="/images/20260512/fig3.webp" class="w-full md:w-2/3 rounded-xl shadow-lg border border-white/10" alt="图3" />
  <p class="text-sm text-slate-500 mt-4 italic">图3：小分子结合蛋白与酶设计</p>
</div>
...
<div class="flex flex-col items-center my-12">
  <img src="/images/20260512/fig4.webp" class="w-full md:w-2/3 rounded-xl shadow-lg border border-white/10" alt="图4" />
  <p class="text-sm text-slate-500 mt-4 italic">图4：新功能蛋白质设计</p>
</div>
